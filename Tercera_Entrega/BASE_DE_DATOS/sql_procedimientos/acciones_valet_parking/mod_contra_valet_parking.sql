...
CREATE PROCEDURE mod_contra_valet_parking(
...
BEGIN
    ...
    IF rol_actual = 'gerente' OR 'admin_rol' THEN
        ...
        -- Cambia la contraseña del usuario valet_parking
    ...
    ELSE
        ...
        SELECT 'No tiene permisos para cambiar la clave de un usuario "valet_parking".' AS resultado;
    END IF;
END $$
