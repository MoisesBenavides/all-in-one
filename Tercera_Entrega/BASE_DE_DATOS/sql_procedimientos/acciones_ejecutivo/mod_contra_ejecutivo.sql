...
CREATE PROCEDURE mod_contra_ejecutivo(
...
BEGIN
    ...
    IF rol_actual = 'jefe_taller' OR 'admin_rol' THEN
        ...
        -- Cambia la contraseña del usuario ejecutivo
    ...
    ELSE
        ...
        SELECT 'No tiene permisos para cambiar la clave de un usuario "ejecutivo".' AS resultado;
    END IF;
END $$
