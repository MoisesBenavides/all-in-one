...
CREATE PROCEDURE mod_contra_gerente(
...
BEGIN
    ...
    IF rol_actual = 'admin_rol' THEN
        ...
        -- Cambia la contraseña del usuario gerente
    ...
    ELSE
        ...
        SELECT 'No tiene permisos para cambiar la clave de un usuario "gerente".' AS resultado;
    END IF;
END $$
