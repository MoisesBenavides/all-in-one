...
CREATE PROCEDURE mod_contra_jefe_taller(
...
BEGIN
    ...
    IF rol_actual = 'gerente' OR 'admin_rol' THEN
        ...
        -- Cambia la contraseña del usuario jefe_taller
    ...
    ELSE
        ...
        SELECT 'No tiene permisos para cambiar la clave de un usuario "jefe_taller".' AS resultado;
    END IF;
END $$
