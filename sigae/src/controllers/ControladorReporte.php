...
class ControladorReporte extends AbstractController {
    ...
    function showProductSalesLastMonth(): Response{
        $response=['success' => false, 'errors' => []];
        ...
        switch($rol){
            case 'gerente':
                try{
                    ...
                    $infoPorProducto = $this->controladorOrden->obtenerIngresosBrutos($rol, 'productos', 'ultimo_mes', $fechaActual);
    ...
    function showParkingSalesLastMonth(): Response{
        $response=['success' => false, 'errors' => []];
        ...
        switch($rol){
            case 'gerente':
                try{
                    ...
                    // Obtener información de ventas de productos, por predeterminado, mensual
                    $infoPorReserva = $this->controladorOrden->obtenerIngresosBrutos($rol, 'parking', 'ultimo_mes', $fechaActual);
    ...
    function showWorkshopServicesSalesLastMonth(): Response{
        $response=['success' => false, 'errors' => []];
        ...
        switch($rol){
            case 'gerente':
                try{
                    ...
                    $infoPorServicio = $this->controladorOrden->obtenerIngresosBrutos($rol, 'taller', 'ultimo_mes', $fechaActual);
    ...
    function showProductSales(): Response{
        $response=['success' => false, 'errors' => []];
        ...
        switch($rol){
            case 'gerente':
                try{
                    ...
                    // Obtener información de ventas de productos, por predeterminado, mensual
                    $infoPorProducto = $this->controladorOrden->obtenerIngresosBrutos($rol, 'productos', 'este_mes', $fechaActual);
    ...
    function showParkingSales(): Response{
        $response=['success' => false, 'errors' => []];
        ...
        switch($rol){
            case 'gerente':
                try{
                    ...
                    // Obtener información de ventas de productos, por predeterminado, mensual
                    $infoPorReserva = $this->controladorOrden->obtenerIngresosBrutos($rol, 'parking','este_mes', $fechaActual);
    ...
    function showWorkshopServicesSales(): Response{
        $response=['success' => false, 'errors' => []];
        ...
        switch($rol){
            case 'gerente':
                try{
                    ...
                    $infoPorServicio = $this->controladorOrden->obtenerIngresosBrutos($rol, 'taller', 'este_mes', $fechaActual);
