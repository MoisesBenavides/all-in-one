...
CREATE PROCEDURE mod_contra_cajero(
...
BEGIN
    ...
    IF rol_actual = 'gerente' OR 'admin_rol' THEN
        ...
        -- Cambia la contraseña del usuario cajero
    ...
    ELSE
        ...
        SELECT 'No tiene permisos para cambiar la clave de un usuario "cajero".' AS resultado;
    END IF;
END $$
